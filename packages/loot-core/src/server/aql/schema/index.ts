...
export const schema = {
  ...
  manual_recurring_entries: {
    id: f('id'),
    name: f('string', { required: true }),
    amount: f('integer', { required: true }),
    category: f('id', { ref: 'categories', required: true }),
    start_month: f('string', { required: true }),
    end_month: f('string'),
    day_of_month: f('integer', { required: true }),
    cadence: f('string', { default: 'monthly', required: true }),
    active: f('boolean', { default: true, required: true }),
    created_at: f('string', { required: true }),
    updated_at: f('string', { required: true }),
    tombstone: f('boolean'),
  },
  rules: {
    id: f('id'),
