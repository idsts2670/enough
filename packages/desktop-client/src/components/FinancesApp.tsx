    ...
    async function run() {
      ...
      dispatch(
        addNotification({
          notification: {
            type: 'message',
            title: t('A new version of Enough is available!'),
            message: t(
          ...
          addNotification({
            notification: {
              ...
              message:
                ...
                'true'
                  ? t(
                      'A new version of Enough is available! Your Pikapods instance will be automatically updated in the next few days - no action needed.',
                    )
                  : t(
                      'Version {{latestVersion}} of Enough was recently released.',
