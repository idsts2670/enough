  ...
  return (
    ...
    >
      ...
      <View style={{ overflowY: 'auto' }}>
        <Paragraph>
          <Trans>
            Enough is a personal finance tool that focuses on beautiful design
        ...
        <Paragraph>
          <Trans>
            Currently, Enough implements budgeting based on a{' '}
            <Link
              variant="external"
        ...
        <Paragraph style={{ color: theme.pageTextLight }}>
          <Trans>
            Get started by importing an existing budget file from Enough or
