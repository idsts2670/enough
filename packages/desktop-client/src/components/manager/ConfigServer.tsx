...
export function ConfigServer() {
  ...
  function getErrorMessage(error: string) {
    switch (error) {
      ...
      default:
        return t(
          'Server does not look like an Enough server. Is it set up correctly?',
        );
    }
  }
          ...
          >
            {currentUrl ? (
              <Trans>
                ...
                server. We will validate that Enough is running at this URL.
              </Trans>
            ) : (
              <Trans>
                ...
                We will validate that Enough is running at this URL.
              </Trans>
            )}
          </Text>
          {error && (
