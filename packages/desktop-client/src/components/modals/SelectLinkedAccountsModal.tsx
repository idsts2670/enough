  ...
  async function onNext() {
    ...
    Object.entries(chosenAccounts).forEach(
      ([chosenExternalAccountId, chosenLocalAccountId]) => {
        const externalAccountIndex = sortedExternalAccounts.findIndex(
        ...
        linkAccountPlaid.mutate({
          externalAccount: sortedExternalAccounts[externalAccountIndex],
          upgradingId:
      ...
      {({ state }) => (
        ...
        >
          ...
          {isNarrowWidth ? (
            ...
            >
              {sortedExternalAccounts.map(account => (
                <AccountCard
            ...
            >
              <TableHeader>
                ...
                <Cell value={t('Account in Enough')} width="flex" />
...
type ExternalAccount = SyncServerPlaidAccount;
...
function getInstitutionName(externalAccount: SyncServerPlaidAccount) {
