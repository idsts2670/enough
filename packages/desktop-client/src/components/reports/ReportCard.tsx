...
export function ReportCard({
    ...
    <View
      ...
      style={{
        ...
        ':hover': {
          ...(to
            ? {
                borderColor: theme.tableBorderHover,
                boxShadow: '0 16px 34px ' + theme.cardShadow,
  ...
  if (to && !isEditing && !disableClick) {
    const openReport = () => navigate(to, { state: { goBack: true } });
    ...
    return (
      <Layout {...layoutProps}>
        <View
          ...
          tabIndex={0}
          onClick={openReport}
          onKeyDown={openReportFromKeyboard}
          style={{
            height: '100%',
            width: '100%',
