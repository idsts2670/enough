export const theme = {
  ...
  accentAction: 'var(--color-accentAction)',
  accentActionHover: 'var(--color-accentActionHover)',
  accentActionPressed: 'var(--color-accentActionPressed)',
  accentActionMuted: 'var(--color-accentActionMuted)',
  onAccentAction: 'var(--color-onAccentAction)',
  ...
  semanticSuccessSoft: 'var(--color-semanticSuccessSoft)',
  semanticWarning: 'var(--color-semanticWarning)',
  semanticWarningSoft: 'var(--color-semanticWarningSoft)',
  semanticError: 'var(--color-semanticError)',
  semanticErrorSoft: 'var(--color-semanticErrorSoft)',
  semanticInfo: 'var(--color-semanticInfo)',
  semanticInfoSoft: 'var(--color-semanticInfoSoft)',
  chatAdvisorAccent: 'var(--color-chatAdvisorAccent)',
  chatAdvisorAccentSoft: 'var(--color-chatAdvisorAccentSoft)',
  chatAdvisorAccentPale: 'var(--color-chatAdvisorAccentPale)',
  chatAdvisorAccentMid: 'var(--color-chatAdvisorAccentMid)',
  chatAdvisorAccentDeep: 'var(--color-chatAdvisorAccentDeep)',
  chatUserAccent: 'var(--color-chatUserAccent)',
  chatUserAccentSoft: 'var(--color-chatUserAccentSoft)',
  chatNeutralSurface: 'var(--color-chatNeutralSurface)',
  chatNeutralSubtle: 'var(--color-chatNeutralSubtle)',
  chatNeutralPale: 'var(--color-chatNeutralPale)',
  chatNeutralBorder: 'var(--color-chatNeutralBorder)',
  chatTextPrimary: 'var(--color-chatTextPrimary)',
  chatTextSecondary: 'var(--color-chatTextSecondary)',
  chatSuccess: 'var(--color-chatSuccess)',
  chatSuccessSoft: 'var(--color-chatSuccessSoft)',
  chatWarning: 'var(--color-chatWarning)',
  chatWarningSoft: 'var(--color-chatWarningSoft)',
  chatError: 'var(--color-chatError)',
  chatErrorSoft: 'var(--color-chatErrorSoft)',
  ...
  categoryFoodTint: 'var(--color-categoryFoodTint)',
  categoryTransport: 'var(--color-categoryTransport)',
  categoryTransportTint: 'var(--color-categoryTransportTint)',
  categoryShopping: 'var(--color-categoryShopping)',
  categoryShoppingTint: 'var(--color-categoryShoppingTint)',
  categoryBills: 'var(--color-categoryBills)',
  categoryBillsTint: 'var(--color-categoryBillsTint)',
  categoryHealth: 'var(--color-categoryHealth)',
  categoryHealthTint: 'var(--color-categoryHealthTint)',
  categoryEntertainment: 'var(--color-categoryEntertainment)',
  categoryEntertainmentTint: 'var(--color-categoryEntertainmentTint)',
  categoryTravel: 'var(--color-categoryTravel)',
  categoryTravelTint: 'var(--color-categoryTravelTint)',
  categoryIncome: 'var(--color-categoryIncome)',
  categoryIncomeTint: 'var(--color-categoryIncomeTint)',
  categoryDebt: 'var(--color-categoryDebt)',
  categoryDebtTint: 'var(--color-categoryDebtTint)',
  categorySavings: 'var(--color-categorySavings)',
  categorySavingsTint: 'var(--color-categorySavingsTint)',
  categoryPersonal: 'var(--color-categoryPersonal)',
  categoryPersonalTint: 'var(--color-categoryPersonalTint)',
